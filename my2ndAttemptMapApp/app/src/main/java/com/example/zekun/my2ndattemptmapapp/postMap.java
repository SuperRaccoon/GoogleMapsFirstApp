...
import com.example.zekun.my2ndattemptmapapp.R;
...
public class postMap extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       String theUser=username.getStringExtra("theUsername");
       String theMessage=username.getStringExtra("theInfo");
        ...
        final Button myUpdateButton = (Button) findViewById(R.id.updateButton);
        ...
        final Button myPostButton = (Button) findViewById(R.id.postButton);
...
//    }
//    public void updateMap(){//can add more functions in the future, all im interested now is if it can accurately track locations
//        Location location = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient1);
//        if (location == null) {
//            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient1, mLocationRequest, this);
//        }
//        else {
//            handleNewLocation(location);
//        }
...
//        LatLng latLng = new LatLng(currentLatitude, currentLongitude);
//
//        mMap.addMarker(new MarkerOptions().position(latLng).title("lol").snippet("lole"));
//    }
//
//    private void handleNewLocation(Location location) {
//        Log.d(TAG, location.toString());
